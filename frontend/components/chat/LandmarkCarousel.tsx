...
export function LandmarkCarousel({ landmarks, onConfirm }: LandmarkCarouselProps) {
  ...
  return (
    <div className="flex flex-col gap-3 my-2 max-w-full overflow-hidden">
      ...
      <Button 
        ...
        className="w-full h-10 gap-2 rounded-xl bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all active:scale-[0.98]"
      >
