...
type MissingInMapLocationTableProps = {
  ...
  onRowClick: (row: LocationRow) => void;
};
      ...
      <table className="w-full min-w-270 border-collapse text-left">
        <thead>
          <tr className="border-b border-slate-200 bg-white">
            ...
            <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Tên địa điểm</th>
            <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Tòa nhà</th>
            <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Tầng</th>
            ...
            {/* <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Ghi chú Admin</th> */}
    ...
    <table className="w-full min-w-270 border-collapse text-left">
      <thead>
        <tr className="border-b border-slate-200 bg-white">
          ...
          <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Tòa nhà</th>
          <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Tầng</th>
          <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Người yêu cầu</th>
          <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Trạng thái</th>
          {/* <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Ghi chú Admin</th> */}
          <th className="px-6 py-4 text-[12px] font-bold text-slate-500 uppercase tracking-widest">Ngày tạo</th>
          <th className="px-6 py-4 text-right text-[12px] font-bold text-slate-500 uppercase tracking-widest">Thao tác</th>
