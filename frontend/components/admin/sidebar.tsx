      ...
      >
        ...
        <nav className="flex-1 py-6 px-2 space-y-1">
          ...
          <Link
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${isKnowledgeRoute
          ...
          <Link
            href="/admin/topic"
            className={`flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${isTopicRoute
                ? "bg-primary text-white shadow-sm ring-1 ring-white/10"
                : "text-blue-200 hover:text-white hover:bg-white/5"
              }`}
          >
          ...
          <Link
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${isMissingInMapRoute
                ? "bg-primary text-white shadow-sm ring-1 ring-white/10"
                : "text-blue-200 hover:text-white hover:bg-white/5"
              }`}
          >
          ...
          <Link
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${isPinnedPostRoute
                ? "bg-primary text-white shadow-sm ring-1 ring-white/10"
                : "text-blue-200 hover:text-white hover:bg-white/5"
              }`}
          >
          ...
          <Link
            href="/admin/rating"
            className={`flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${isRatingRoute
                ? "bg-primary text-white shadow-sm ring-1 ring-white/10"
                : "text-blue-200 hover:text-white hover:bg-white/5"
              }`}
          >
