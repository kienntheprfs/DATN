...
export interface FAQQuestionVariant {
  id: number;
  question: string;
  embedding_id: string;
}
...
export const faqApi = {
  list: async (skip = 0, limit = 50): Promise<FAQListResponse> => {
    console.log('[FAQ API] GET /kb/faqs/manual', { skip, limit });
