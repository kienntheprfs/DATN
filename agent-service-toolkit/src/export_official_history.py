...
async def export_chat_histories_to_file(db_uri: str, output_filepath: str = "chat_history_export.json"):
            ...
            if messages:
                ...
                for m in messages:
                    try:
                        ...
                        # (Tùy chọn) Nếu muốn giữ lại timestamp gốc từ additional_kwargs của bạn
