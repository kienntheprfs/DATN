...
# from rag_utils.encoder import HybridQueryEncoder
# from rag_utils.retriever import QdrantHybridRetriever
# from rag_utils.qdrant import VectorStore

# from rag_utils.dense_embedding.azure import AzureEmbeddingService
# from rag_utils.sparse_vector_embedding import SparseEmbeddingService

# # Init embedding services
# dense_service = AzureEmbeddingService()
# sparse_service = SparseEmbeddingService()

# # Init encoder (gộp dense + sparse)
# encoder = HybridQueryEncoder(
#     dense_service=dense_service,
#     sparse_service=sparse_service,
# )

# # Init Qdrant VectorStore
...
#     try:
#         # 🔥 DÙNG QDRANT RETRIEVER CỦA BẠN
#         docs = await retriever.retrieve(query)

#         document_summaries = []
#         for i, doc in enumerate(docs, 1):
#             document_summaries.append({
#                 "id": doc.get("doc_id", f"doc-{i}"),
