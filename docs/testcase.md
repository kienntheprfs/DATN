...
### ut-001: Chuẩn hóa tên địa điểm (NLP)
...
### ut-002: Thuật toán tìm đường Dijkstra
...
### ut-003: Trích xuất Node ID từ Tool input
...
### it-001: Tìm kiếm Alias & Building
...
### it-002: Tìm đường liên tầng (Database Integration)
...
### st-001: Quản trị - Tạo Tòa nhà & Tầng
...
### st-002: Quản trị - Vẽ Map & Lưu trữ
...
### st-003: Người dùng - Tìm đường & Step-by-step
...
### st-004: Người dùng - Chuyển tầng 3D
...
### at-001: Chatbot - Giải quyết nhập nhằng (Loop Fix)
...
### at-002: Chatbot - Hiển thị MapPreview
